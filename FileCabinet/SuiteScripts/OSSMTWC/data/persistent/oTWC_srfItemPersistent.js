...
define(['SuiteBundles/Bundle 548734/O/core.js', 'SuiteBundles/Bundle 548734/O/core.sql.js', 'SuiteBundles/Bundle 548734/O/data/rec.utils.js', '../../O/data/oTWC_baseRecord.js' ],
    (core, coreSQL, recu, customRec) => {
        ...
        var _recordFieldInfo = {
            ...
            LENGTH_MM: { name: 'custrecord_twc_srf_itm_length_mm', type: 'integer', alias: 'lengthmm', display: 'normal', mandatory: false },
            WIDTH_MM: { name: 'custrecord_twc_srf_itm_width_mm', type: 'integer', alias: 'widthmm', display: 'normal', mandatory: false },
            DEPTH_MM: { name: 'custrecord_twc_srf_itm_depth_mm', type: 'integer', alias: 'depthmm', display: 'normal', mandatory: false },
