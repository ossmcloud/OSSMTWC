...
define(['SuiteBundles/Bundle 548734/O/core.js', 'SuiteBundles/Bundle 548734/O/core.sql.js', 'SuiteBundles/Bundle 548734/O/data/rec.utils.js', '../../O/data/oTWC_baseRecord.js' ],
    (core, coreSQL, recu, customRec) => {
        ...
        var _recordFields = {
            ...
            RF_CERTIFIED_EXPIRY: 'custrecord_twc_prof_rf_cert_exp',
        ...
        var _recordFieldInfo = {
            ...
            RF_CERTIFIED_EXPIRY: { name: 'custrecord_twc_prof_rf_cert_exp', type: 'date', alias: 'rFCertifiedExpiry', display: 'normal', mandatory: false },
