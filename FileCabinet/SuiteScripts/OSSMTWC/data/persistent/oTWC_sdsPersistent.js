...
define(['SuiteBundles/Bundle 548734/O/core.js', 'SuiteBundles/Bundle 548734/O/core.sql.js', 'SuiteBundles/Bundle 548734/O/data/rec.utils.js', '../../O/data/oTWC_baseRecord.js' ],
    (core, coreSQL, recu, customRec) => {
        ...
        var _recordFieldInfo = {
            ...
            ADDITIONAL_SRF_CONIDITONS: { name: 'custrecord_twc_sds_add_cond', type: 'clobtext', alias: 'additionalSRFConiditons', display: 'normal', mandatory: false },
            POWER_SUPPLY_COMMENTS: { name: 'custrecord_twc_sds_power_supply_notes', type: 'clobtext', alias: 'powerSupplyComments', display: 'normal', mandatory: false },
