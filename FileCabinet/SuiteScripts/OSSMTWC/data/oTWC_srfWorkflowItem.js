...
define(['SuiteBundles/Bundle 548734/O/core.js', 'SuiteBundles/Bundle 548734/O/core.sql.js', './persistent/oTWC_srfWorkflowItemPersistent.js', './oTWC_config.js'],
    (core, coreSQL, twcSafWorkflowItem, twcConfig) => {
        ...
        class OSSMTWC_SRFWorkflowItem extends twcSafWorkflowItem.PersistentRecord {
        ...
        return {
            ...
            getField: (name) => {
                for (var k in twcSafWorkflowItem.FieldsInfo) {
                    if (twcSafWorkflowItem.FieldsInfo[k].name == name) {
                        return twcSafWorkflowItem.FieldsInfo[k];
                    }
                }
            }
