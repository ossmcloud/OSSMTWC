 ...
 * @NModuleScope public
 */
define(['N/runtime', 'SuiteBundles/Bundle 548734/O/core.js', 'SuiteBundles/Bundle 548734/O/core.sql.js', './oTWC_utils.js', './oTWC_srf.js', './oTWC_saf.js', './oTWC_srfItemType.js', './oTWC_file.js', './oTWC_equipment.js'],
    (runtime, core, coreSQL, twcUtils, twcSrf, twcSaf, twcSrfItemType, twcFile, twcEquipment) => {
        ...
        function getStepTableUIControl(saf, stepType) {
            var label = '';
            ...
            return {
                id: `${twcSaf.Type}_${stepType}`, recordType: twcSaf.Type, label: label,
                fields: fields,
                // where: {
                //     [twcSaf.Fields.SRF]: saf.id || 0,
                //     [twcSaf.Fields.STEP_TYPE]: stepType,
                // },
