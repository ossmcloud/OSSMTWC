 ...
 */
define(['SuiteBundles/Bundle 548734/O/core.js', 'SuiteBundles/Bundle 548734/O/core.date.js', 'SuiteBundles/Bundle 548734/O/core.sql.js', 'SuiteBundles/Bundle 548734/O/ui/nsSuitelet.js', './views/oTWC_baseView.js', '../ui/modules/oTWC_companyProfileUtils.js', '../O/controls/oTWC_ui_fieldPanel.js'],
    function (core, cored, coreSql, uis, twcBaseView, twcCompanyProfileUtils, twcUIPanel) {
        ...
        suiteLet.get = (context, s) => {
            ...
            var fieldGroups = twcCompanyProfileUtils.getCompanyInfoPanels(pageData.profileInfo, pageData.userInfo);
